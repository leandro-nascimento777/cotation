...
export const BoardingPassTicket = ({
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[20px] border border-[#6E44FF]/30 bg-white p-5 shadow-2xl transition-all sm:rounded-[28px] md:rounded-[36px] sm:p-6 md:p-8 lg:px-12 lg:py-7 font-ticket min-h-[340px] sm:min-h-[370px] md:min-h-[400px] lg:min-h-[430px] flex flex-col justify-between">
      ...
      <div className="relative z-10 flex flex-row items-center gap-5 sm:gap-6 md:gap-10 lg:gap-12 h-full flex-1">
        ...
        <TicketBarcode code={numero ? `COT ${numero} 001 02` : undefined} />
        ...
        <div className="flex flex-1 flex-col justify-between gap-3 sm:gap-4 md:gap-5 min-w-0 h-full py-0.5">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-5 md:gap-6">
            <div>
              ...
              <div className="mt-0.5 flex flex-col gap-0.5">
                {passengers.map((p, i) => (
                  <span
                    key={i}
                    className="font-ticket text-sm font-bold tracking-tight text-[#6E44FF] sm:text-base md:text-lg lg:text-xl"
                  >
            ...
            <div>
              ...
              <span className="mt-0.5 block font-ticket text-sm font-bold tracking-tight text-[#6E44FF] sm:text-base md:text-lg lg:text-xl">
                {formattedIda}
              </span>
            </div>
            ...
            <div className="sm:text-right">
              ...
              <span className="mt-0.5 block font-ticket text-sm font-bold tracking-tight text-[#6E44FF] sm:text-base md:text-lg lg:text-xl truncate">
                {destinoDisplay}
              </span>
            </div>
          </div>

          {/* Centro: Códigos IATA e Avião inclinados em cor roxa oficial (Anexo 1) */}
          <div className="my-1 flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex flex-col items-center text-center">
              <span className="font-ticket text-5xl font-bold tracking-tight text-[#6E44FF] sm:text-6xl md:text-7xl lg:text-8xl xl:text-[6.2rem] leading-none block">
                {originInfo.iata}
              </span>
            ...
            {/* Avião oficial centralizado com a mesma cor das letras (#6E44FF) */}
            <div className="flex flex-1 items-center justify-center px-2">
              <AirplaneTicketIcon className="h-12 w-28 sm:h-14 sm:w-36 md:h-18 md:w-44 lg:h-20 lg:w-48 text-[#6E44FF] transition-transform duration-300 hover:scale-105" />
            </div>
          ...
          <div className="relative flex flex-col items-center justify-between gap-3 sm:flex-row mt-1">
            ...
            <div className="flex flex-col items-center justify-center text-center sm:absolute sm:left-1/2 sm:-translate-x-1/2 w-full sm:w-auto px-2">
              <span className="font-ticket text-xl font-bold tracking-[0.22em] text-[#6E44FF] uppercase sm:text-2xl md:text-3xl">
                COTAÇÃO
              </span>
              <p className="mt-0.5 max-w-sm font-ticket text-[9px] font-semibold tracking-wide text-[#6E44FF] uppercase sm:text-[10px] md:text-[11px] md:max-w-md lg:max-w-lg leading-tight">
            ...
            <div className="w-full flex items-center justify-end sm:ml-auto">
              <div className="text-right">
                ...
                <span className="font-ticket text-xl font-bold tracking-tight text-[#6E44FF] uppercase sm:text-2xl md:text-3xl lg:text-4xl">
                  {flightClass}
                </span>
              </div>
            </div>
